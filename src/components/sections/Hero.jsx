  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <div className="absolute inset-0 z-10">
        ...
        <div className="absolute top-40 right-20 w-32 h-32 bg-secondary-200/15 rounded-full blur-2xl animate-float [animation-delay:1s]"></div>
        <div className="absolute bottom-40 left-20 w-24 h-24 bg-emerald-200/20 rounded-full blur-xl animate-float [animation-delay:2s]"></div>
      </div>
